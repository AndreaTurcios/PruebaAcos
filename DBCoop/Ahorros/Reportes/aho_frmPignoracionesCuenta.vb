...
Public Class aho_frmPignoracionesCuenta
    ...
    Private Sub aho_frmMovimientoCuenta_Reporte_Click() Handles Me.Reporte
        Dim rpt As New aho_rptPignoracionesCuenta
        rpt.DataSource = blAhorro.rptPignoracionCuentaAhorro(teIdCuenta.EditValue, deDesde.EditValue, deHasta.EditValue)
        rpt.DataMember = ""
    ...
    Private Sub aho_frmMovimientoCuenta_ReporteExcel() Handles Me.ReporteExcel
        DataTableToExcel(blAhorro.rptPignoracionCuentaAhorro(teIdCuenta.EditValue, deDesde.EditValue, deHasta.EditValue), "")
    End Sub
End Class
