...
Public Class apo_frmEliminaAyudaFuneraria
    ...
    Private Sub cmdEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdEliminar.Click
        ...
        Dim UltMov As Integer = blAporta.GetUltMovFune(teNumeroAsociad.EditValue)
        ...
        If MsgBox("Está seguro(a) de eliminar el registro de ayuda funeraria?", MsgBoxStyle.YesNo + MsgBoxStyle.Information) = MsgBoxResult.No Then
            Exit Sub
        End If
        Try
            objTablas.coo_MovFunerariaDeleteByPK(teNumeroAsociad.EditValue, teIdMov.EditValue)
        Catch ex As Exception
            MsgBox(String.Format("No fue posible eliminar el Movimiento de Ayuda funeraria{0}{1}", Chr(13), ex.Message()), MsgBoxStyle.Critical, "Error al elminar el registro")
            Exit Sub
        End Try
    ...
    Private Sub teNumAsociado_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles teNumAsociado.Validated
        ...
        Dim IdMov As Integer = blAporta.GetUltMovFune(teNumeroAsociad.EditValue)
        Dim entMov As coo_MovFuneraria = objTablas.coo_MovFunerariaSelectByPK(teNumeroAsociad.EditValue, IdMov)
        ...
        With entMov
            ...
            Else
                teTipo.EditValue = "INGRESO DE AYUDA FUNERARIA"
            End If

            If blAporta.GetUltFechaFune(teNumeroAsociad.EditValue) Is Nothing Then
                deFechaUlt.EditValue = Today
            Else
                deFechaUlt.EditValue = blAporta.GetUltFechaFune(teNumeroAsociad.EditValue)
            End If
        End With
