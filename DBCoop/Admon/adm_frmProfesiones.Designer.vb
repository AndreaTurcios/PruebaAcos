...
Partial Class adm_frmProfesiones
    ...
    Private Sub InitializeComponent()
        ...
        Me.gc.Name = "gc"
        Me.gc.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.chkAsegurado})
        ...
        'gv
        '
        Me.gv.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.gcId, Me.gcNombre, Me.gcAsegurado})
        ...
        Me.gcAsegurado.Visible = True
        Me.gcAsegurado.VisibleIndex = 2
        '
        'chkAsegurado
        '
