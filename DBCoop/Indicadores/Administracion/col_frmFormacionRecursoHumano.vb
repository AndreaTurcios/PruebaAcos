...
Imports System.Math
Public Class col_frmFormacionRecursoHumano
    ...
    Dim Definicion As String = "Mide la porción de ingresos que se destina al desarrollo " + _
"del recurso humano, indicador que permite observar la importancia " + _
"del mismo en la estrategia de desarrollo de la Cooperativa."
    Private Sub gen_frmIndicador_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ent = bl.col_IndicadoresParametrosSelectByPK("FormacionDelRecursoHumano")
    ...
    Private Sub rgCorreciones_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rgCorreciones.SelectedIndexChanged
        Select Case rgCorreciones.EditValue
            Case 1
                meTexto.EditValue = "Una alternativa es realizar un estudio que permita establecer " + _
  "cuál es la brecha entre el nivel profesional y de habilidad del personal " + _
  "y el requerido para la organización (comparación con organizaciones " + _
  "similares), que defina la política de desarrollo del recurso humano."
            Case 2
                meTexto.EditValue = "Es fundamental que la Cooperativa emita una política " + _
  "de incentivos y la de a conocer ampliamente a sus colaboradores.  " + _
  "Dicha política debe ser emitida por el Consejo de Administración."
            Case 3
                meTexto.EditValue = "Una alternativa es la de mantenerse vinculada con centros de " + _
  "capacitación y educación tanto del entorno cooperativo como del entorno " + _
  "financiero, que alimente constantemente con propuestas a la organización."
            Case 4
                meTexto.EditValue = "En el desarrollo del recurso humano se debe considerar la política " + _
  "de realizar actividades grupales como de permitir el desarrollo individual."
        End Select
    End Sub

    Private Sub sbAfecta_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sbAfecta.Click
        meTexto.EditValue = "Los gastos de formación que más se consideran son los asociados " + _
"con el desarrollo de habilidades y de técnicas para realizar una labor " + _
"con eficiencia.  Se supone que la Cooperativa recluta desde el inicio " + _
"personal capacitado para desarrollar su trabajo, y no aprendices generales " + _
"que deben de ser formados.  Así, la formación y el entrenamiento es " + _
"especializada en las tecnologías de proceso, de información y de gestión, " + _
"en la doctrina y filosofía cooperativa, en el manejo del CUADRO DE MANDO " + _
"FINANCIERO y temas afines.  Además, se recomienda el establecimiento de " + _
"una política de formación de recusos humanos que le genere algún grado de " + _
"subsidio para estudios superiores, sobre todo si los mismos lo amarran a " + _
"la organización de tal suerte que el trabajador beneficiario le retribuya"
    End Sub

    Private Sub sbVerFormula_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles sbVerFormula.Click
        ind_frmFormulasFinancieras.IdFormula = 49
        ind_frmFormulasFinancieras.cIndice = "FORMACION DEL RECURSO HUMANO"
