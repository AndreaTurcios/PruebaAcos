...
Public Class aso_frmProgramacionSocio
    ...
    Private Sub apo_frmEstadoCuentaAportacion_Report_Click() Handles Me.Reporte
        If teIdAsociado.EditValue = 0 Then
            ...
            Exit Sub
        End If
        Dim rpt As New aso_rptProgramacionSocio
        rpt.DataSource = blAporta.rptProgramacionSocio(teIdAsociado.EditValue, deFecha.EditValue)
        rpt.DataMember = ""
